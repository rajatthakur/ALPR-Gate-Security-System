...
# Reading Image
img = cv2.imread("/home/rajat/car5.jpg")
...
# # Creating a Named window to display image
cv2.imwrite("Gray Converted Image.jpg",img_gray)
# Display Image
...
# # Creating a Named window to display image
cv2.imwrite("Noise Removed Image.jpg",noise_removal)
# Display Image
...
# # Creating a Named window to display image
cv2.imwrite("After Histogram equalisation.jpg",equal_histogram)
# Display Image
...
# # Creating a Named window to display image
cv2.imwrite("Morphological opening.jpg",morph_image)
# Display Image
...
# # Creating a Named window to display image
cv2.imwrite("Subtraction image.jpg", sub_morp_image)
# Display Image
...
# # Creating a Named window to display image
cv2.imwrite("Image after Thresholding.jpg",thresh_image)
# # Display Image
...
# # Creating a Named window to display image
cv2.imwrite("ImageCanny.jpg",canny_image)
# # Display Image
...
# # Creating a Named window to display image
cv2.imwrite("Dilation.jpg", dilated_image)
# # Displaying Image
...
# # Creating a Named window to display image
cv2.imwrite("Image with Selected Contour.jpg",final)
...
# Creating a Named window to display image
cv2.imwrite("EnhancedNumberPlate.jpg",final_image)
# Display image
